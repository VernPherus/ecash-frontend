...
const FundStatCard = ({
  ...
  return (
    <div className="card-static group flex h-full flex-col overflow-hidden transition-all duration-300 hover:shadow-medium bg-base-100 border border-base-200 rounded-xl">
      {/* Header Section */}
      <div className="px-6 py-5 flex items-start justify-between bg-base-200/50 border-b border-base-200">
        <div className="flex items-center gap-4 w-full">
          <div className="w-12 h-12 shrink-0 rounded-xl bg-base-100 shadow-sm flex items-center justify-center text-primary border border-base-200">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex justify-between items-start">
              ...
              <span className="shrink-0 px-2.5 py-1 rounded-md text-xs font-bold tracking-wider uppercase bg-base-100 border border-base-200 text-base-content/70 shadow-sm">
                {fundCode}
              </span>
            </div>
          </div>
      ...
      <div className="p-6 flex flex-col gap-5 flex-1">
        ...
        <div className="relative overflow-hidden rounded-xl bg-primary/10 border border-primary/20 shadow-sm">
          ...
          <div className="flex items-center p-4 pl-5 gap-4">
            <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-base-100/60 text-primary shadow-sm backdrop-blur-sm shrink-0">
        ...
        <div className="relative overflow-hidden rounded-xl bg-warning/15 border border-warning/30 shadow-sm">
          ...
          <div className="flex items-center p-4 pl-5 gap-4">
            <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-base-100/60 text-warning-content/80 lg:text-warning shadow-sm backdrop-blur-sm shrink-0">
        ...
        <div className="relative overflow-hidden rounded-xl bg-info/15 border-2 border-info/30 shadow-sm">
          ...
          <div className="flex items-center p-5 pl-5 gap-4">
            <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-base-100/60 text-info shadow-sm backdrop-blur-sm shrink-0">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="py-4 px-2 flex flex-col items-center justify-center text-center rounded-xl bg-red-500/10 border border-red-500/20 shadow-sm transition-all duration-300">
            ...
            {/* Standard Text Color (Not blended with red) */}
            <span className="text-2xl font-black text-base-content font-mono leading-none">
              {cancelledLDDAPNum || 0}
            </span>
            {/* Standard Text Color, Larger Label */}
            <span className="text-sm font-bold text-base-content uppercase mt-2 leading-tight">
              Cancelled LDDAP
            </span>
          </div>
