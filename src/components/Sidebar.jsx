...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            items: [
                { path: "/admin/users", icon: Shield, label: "User Manager", adminOnly: true },
                { path: "/admin/logs", icon: FileText, label: "Activity Logs", adminOnly: true },
                { path: "/admin/signup", icon: UserPlus, label: "Add User", adminOnly: true },
            ],
        },
        {
            section: "Account",
