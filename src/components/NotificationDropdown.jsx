    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className="relative p-2 rounded-xl hover:bg-base-200 transition-colors duration-200 group"
                aria-label="Notifications"
            >
                <Bell className="w-5 h-5 text-base-content/70 group-hover:text-base-content transition-colors" />

                {/* Unread Badge */}
                {unreadCount > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center text-[10px] font-bold text-white bg-error rounded-full px-1 animate-pulse">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex gap-3">
                                                {/* Type Icon */}
                                                <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${typeStyle}`}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-start justify-between gap-2">
                                                        <p className={`text-sm font-medium truncate ${!notification.isRead ? "text-base-content" : "text-base-content/70"}`}>
                                                            {notification.title}
                                                        </p>
                                                        {/* Remove Button */}
                                                        <button
