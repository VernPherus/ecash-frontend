...
const Check = ({ onClose, initialData }) => {
  ...
  const handleConfirmedSubmit = async () => {
    ...
    // Filter items to only include complete ones
    ...
    // Filter deductions to only include valid ones
  ...
  // Calculate amounts for display in confirmation modal
          ...
          <div className="relative bg-base-100 rounded-xl shadow-2xl max-w-md w-full p-6 animate-scaleIn border border-base-200">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-base-content mb-2">
                  {isEdit ? "Confirm Update" : "Confirm Check Creation"}
                </h3>
                <p className="text-sm text-base-content/70 leading-relaxed">
                  {isEdit
                    ? `Are you sure you want to update Check "${formData.checkNum}"? This will modify the existing record.`
                    : `Are you sure you want to create a new Check "${formData.checkNum}"? Please verify all information is correct.`}
                </p>
              </div>
            </div>
            ...
            <div className="bg-base-200/50 rounded-lg p-4 mb-6 space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-base-content/60">Check Number:</span>
