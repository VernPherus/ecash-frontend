...
const DashboardPage = () => {
  ...
  const {
    disbursements, // We use this for the table data now
    fetchDisbursements,
    getStats,
    getDisbursementStatus,
    isLoading: disbursementsLoading,
    pagination, // We need this from the store
  } = useDisbursementStore();

  useEffect(() => {
    fetchFunds();
    fetchDisbursements(1); // Fetch page 1 on mount
  }, [fetchFunds, fetchDisbursements]);

  const handlePageChange = (newPage) => {
    fetchDisbursements(newPage);
  };
  ...
  const getFundLiquidity = (fund) => {
    // Note: Ideally, 'spent' should come from a backend summary endpoint
    // because 'disbursements' here only contains the current page of data.
    // For now, we keep logic as is, but be aware of this calculation limitation on paginated data.
    ...
    const percentage =
      fund.initialBalance > 0 ? (spent / Number(fund.initialBalance)) * 100 : 0;
  ...
  return (
    <div className="min-h-screen bg-base-200">
      ...
      <div className="p-8 max-w-7xl mx-auto space-y-8">
          ...
          {fundsLoading ? (
            ...
            <div className="card-static p-12 text-center">
              ...
              <p className="text-sm text-base-content/40 mb-4">
                Get started by adding your first fund source
              </p>
              <button
                onClick={() => navigate("/funds")}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex justify-between text-xs text-base-content/50">
                      ...
                      <span
                        className={isCritical ? "text-error font-medium" : ""}
                      >
        ...
        <section
          className="card-static overflow-hidden animate-fade-in-up"
            ...
            <>
              <div className="overflow-x-auto">
                <table className="table-modern">
                  ...
                  {/* CHANGE: Mapped over 'disbursements' (paginated list) instead of 'recentDisbursements' */}
                  <tbody>
