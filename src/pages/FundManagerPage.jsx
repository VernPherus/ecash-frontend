...
const FundManagerPage = () => {
    const { funds, fetchFunds, isLoading, getFundColor, setSelectedFund, selectedFund } = useFundStore();
    ...
    const totalBudget = funds.reduce((sum, f) => sum + Number(f.initialBalance || 0), 0);
            ...
            <div className="p-8 max-w-7xl mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="stat-card">
                        <div>
                            <p className="text-sm text-base-content/60 font-medium mb-1">Total Fund Sources</p>
                            <h3 className="text-3xl font-bold text-base-content">{funds.length}</h3>
                        </div>
                    ...
                    <div className="stat-card">
                        <div>
                            <p className="text-sm text-base-content/60 font-medium mb-1">Total Budget</p>
                            <h3 className="text-2xl font-bold text-base-content">{formatCurrency(totalBudget)}</h3>
                        </div>
                    ...
                    <div className="stat-card">
                        <div>
                            <p className="text-sm text-base-content/60 font-medium mb-1">Active Funds</p>
                ...
                <div className="card-static overflow-hidden">
                    {isLoading ? (
                        <div className="p-8 text-center">
                            ...
                            <p className="mt-4 text-base-content/60">Loading fund sources...</p>
                        </div>
                        ...
                        <div className="p-12 text-center">
                            ...
                            <h3 className="text-lg font-semibold text-base-content/60 mb-2">
                                {searchQuery ? "No funds match your search" : "No Fund Sources Yet"}
                            </h3>
                                ...
                                <tbody>
                                    {filteredFunds.map((fund, idx) => (
                                        <tr key={fund.id}>
                                            ...
                                            <td className="font-semibold text-base-content">{fund.name}</td>
                                            ...
                                            <td className="text-center">
                                                <span
                                                    className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${fund.isActive !== false
                                            ...
                                            <td className="text-center">
                                                <div className="flex items-center justify-center gap-1">
                                                    ...
                                                    <div className="dropdown dropdown-end">
                                                        ...
                                                        <ul
                                                            tabIndex={0}
                                                            className="dropdown-content z-[1] menu p-2 shadow-lg bg-base-100 rounded-lg w-40 border border-base-300"
                                                        >
                                                            <li>
