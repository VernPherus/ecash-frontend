...
const DisbursementFormPage = () => {
   ...
   <header className="bg-white border-b border-slate-100 px-110 py-4 flex  items-center sticky top-0 z-10">
...
<div className="bg-white border-b border-slate-200 px-6 lg:px-8 py-3">
    <div className="max-w-7xl mx-auto flex gap-2">
        <NavLink 
            to="./components/disbursement_components/Check" 
            className={({ isActive }) =>
        ...
        <NavLink 
            to="./components/disbursement_components/lddap" 
            className={({ isActive }) =>
                `px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors ${
                    isActive 
                        ? 'bg-slate-900 text-white' 
